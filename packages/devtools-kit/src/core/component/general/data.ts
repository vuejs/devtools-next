...
export function replacerForInternal(key: string) {
...
export function componentStateValueType(value, raw = true) {
  ...
  if (value == null || value === UNDEFINED) {
    ...
    if ((raw || value._custom.display != null))
      ...
      return componentStateValueType(value._custom.value)
  }
...
export function formatComponentStateValue(value, quotes = false) {
  let result
  const type = componentStateValueType(value, false)
